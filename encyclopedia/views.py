...
import re
import markdown2
from encyclopedia.markdownify import convert
...
def entry(request,TITLE):
    ...
    if TITLE in util.list_entries():
        ...
        return render(request, "encyclopedia/entry.html", context={'title':TITLE, 'content':convert(content)})
...
def savenewpage(request):
    ...
    if title:
        ...
        message = 'You have to write a title to save a newpage.'
        return render(request, 'encyclopedia/newpage.html', context={'message':message})
